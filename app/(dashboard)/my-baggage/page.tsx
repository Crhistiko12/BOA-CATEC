...
import { Package, Dog, CheckCircle2, AlertCircle, Sparkles } from 'lucide-react'
                        ...
                        <div className="group relative">
                            ...
                            <div className="relative dark:bg-white/10 bg-white/50 backdrop-blur-2xl rounded-3xl shadow-2xl p-6 dark:border dark:border-white/20 border border-white/40 overflow-hidden dark:hover:border-white/40 hover:border-white/60 transition-all duration-500">
                                ...
                                <div className="space-y-4">
                                    {/* Baggage Item */}
                                    <div className="p-4 dark:border-2 dark:border-cyan-500/30 border-2 border-cyan-300/50 rounded-2xl dark:bg-gradient-to-br dark:from-cyan-500/10 dark:to-teal-500/10 bg-gradient-to-br from-cyan-300/30 to-teal-300/20 dark:hover:from-cyan-500/20 dark:hover:to-teal-500/20 hover:from-cyan-300/50 hover:to-teal-300/40 transition-all duration-300">
                                        <div className="flex justify-between items-start mb-3">
                                            ...
                                            <span className="px-3 py-1 dark:bg-yellow-500/80 bg-yellow-400/80 dark:text-yellow-50 text-yellow-900 rounded-lg text-xs font-bold flex items-center gap-1">
                                                <AlertCircle className="h-3 w-3" />
                                                EN PROCESO
                                            </span>
                                        </div>
                                        <div>
                                            <p className="font-bold dark:text-white text-slate-800">Maleta Facturada</p>
                                            <p className="text-sm dark:text-white/60 text-slate-600">Reserva: BOA-998877</p>
                                            <p className="text-sm font-semibold dark:text-cyan-300 text-cyan-700 mt-2">23 kg</p>
                                        </div>
                                    </div>

                                    {/* Pet Item */}
                                    <div className="p-4 dark:border-2 dark:border-purple-500/30 border-2 border-purple-300/50 rounded-2xl dark:bg-gradient-to-br dark:from-purple-500/10 dark:to-pink-500/10 bg-gradient-to-br from-purple-300/30 to-pink-300/20 dark:hover:from-purple-500/20 dark:hover:to-pink-500/20 hover:from-purple-300/50 hover:to-pink-300/40 transition-all duration-300">
                                        <div className="flex justify-between items-start mb-3">
                                        ...
                                        <div>
                                            <p className="font-bold dark:text-white text-slate-800">Mascota en Cabina</p>
                                            <p className="text-sm dark:text-white/60 text-slate-600">Reserva: BOA-900</p>
                                            <p className="text-sm font-semibold dark:text-pink-300 text-pink-700 mt-2">Max (Bulldog)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
